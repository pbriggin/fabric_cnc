    ...
    def _configure_grbl_settings(self):
        ...
        try:
            ...
            settings = {
                ...
                "$23": "11",      # Homing direction mask (X=1, Y=2, A=8, total=11, Z not inverted)
                "$24": "1500.0",  # Homing seek rate (fast initial search)
                "$25": "500.0",   # Homing feed rate (slow precision approach)
